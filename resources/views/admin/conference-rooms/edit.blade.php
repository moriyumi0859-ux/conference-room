...
<body class="bg-gray-100 min-h-screen">
    ...
    <main class="max-w-2xl mx-auto py-8 px-4">
        ...
        <div class="bg-white rounded shadow p-6 mt-4">
            <h2 class="text-xl font-bold mb-6">会議室編集</h2>
